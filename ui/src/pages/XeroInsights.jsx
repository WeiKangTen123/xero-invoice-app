...
export default function XeroInsights() {
  ...
  async function fetchSummary(opts = {}) {
    ...
    try {
      ...
      setError(err.message || 'Could not load Xero Insights');
    } finally {
      setRefreshing(false);
    }
  }
  ...
  if (error && !data) {
    return (
      <div>
        <div className="page-header"><h1>Xero Insights</h1></div>
      ...
      <div>
        ...
        <div className="card" style={{ textAlign: 'center', padding: '48px 24px' }}>
          ...
          <div style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 18, maxWidth: 380, marginInline: 'auto' }}>
            Xero Insights reads from whatever connection you already set up — nothing to configure here.
